...
if __name__ == "__main__":
    ...
    if on():
        print("Debugging is not initialized")
    ...
    if on():
        print("1. ANY Debugging is on")
    if on(Data1):
        print("1. Data1 debugging is on")
    if on(Function):
        print("1. Function debugging is on")
    if on(Application):
        print("1. Application debugging is on")

    activate(Data1 | Application)
    if on():
        print("2. ANY Debugging is on")
    if on(Data1):
        print("2. Data1 debugging is on")
    if on(Function):
        print("2. Function debugging is on")
    if on(Application):
        print("2. Application debugging is on")

    activate(Data1 | Function | Application)
    if on():
        print("3. ANY Debugging is on")
    if on(Data1):
        print("3. Data debugging is on")
    if on(Function):
        print("3. Function debugging is on")
    if on(Application):
        print("3. Application debugging is on")
